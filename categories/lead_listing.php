                ...
                <div class="buddypress_content notfilter">
                  <div class="buddy_image col-md-2 pull-left">
                    ...
                    <div class="buddy_desc col-md-10 ">
                      ...
                      <small><a href="#"><?php echo $sk['category']; ?></a>, <a href="#"><?php echo $sk['subcategory']; ?></a></small>
                    
                    <p><strong  >Experience</strong>: <?php echo $sk['experience']; ?>years
                    </p><p>
                    <strong >Charge</strong> : <i class="fa fa-rupee"></i> <?php echo $sk['price']; ?>&nbsp;&nbsp;<?php if(!empty($sk['charge_mode'])) { echo $sk['charge_mode']; } ?>
                    </p>
...
<div id="copyrights">
  ...
  <div class="dmtop" style="margin-bottom:120px;">Scroll to Top</div>
...
$(document).ready(function(){
  ...
  $("#submit").click(function(){
    ...
    { 
      ...
      ({
        type: "POST",
        url: "backend/new_search_buyer.php",
        data: ajx,
        cache: false,
        success: function(html)
        {
