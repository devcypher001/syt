...
$sql = mysql_query("SELECT * FROM `syt_post` WHERE `zip` like '%$location%' or `zip` like '%$keyword%' and `category` like '%$subcategory%'");
...
{
?>
	<p style='margin-left:2%;'><font color="red" size="6">Currently,there are not matching profile.you can post your requirement.</font></p>
<?php
}
else
{
