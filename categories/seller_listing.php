    ...
    <div class="header-top-bar">
      <div class="container">
		...
		<div class="header-logo text-center">
          <a href="../index.php"><img src="img/logo.png" style="margin-top:-2px;"></a>
        </div>
        <div class="header-login" style="margin-left: 30.5%;">

          <a href="#" class="" style="color:white;font-size:14px;">CATEGORIES</a>
          ...
          <div style="width: 488px; height: 268px; color: #0F7AC1; font-size: 18px; line-height: 3; 
            ...
            <ul style="display:inline; list-style-type: none;">
                ...
                <li style="float:right;">
                <a href="category_listing.php?catid=9" style="color: #0F7AC1;">Social Causes</a>
                </li>
        ...
        <div class="header-call-to-action">
          <a href="../register" class="btn btn-default"><i class="fa fa-plus"></i>Post requirement</a>
          ...
          <div class="container">
			...
			<div class="category-search">
				...
				<?php
					...
					$subcategory = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category` = '$category_id' order by `subcategory`");
              ...
              <div class="select-location">
                <select class="" data-placeholder="-Select location-" id="location">
                  <option value="110092">Anand Vihar</option>
                  <option value="110051">Azad Nagar</option>
                  <option value="110032">Babarpur</option>
                  <option value="110091">Chilla</option>
                  <option value="110032">Distt. Court</option>
                  <option value="110031">Gandhi Nagar</option>
                  <option value="110085">Rohini</option>
                </select>
              </div>
            ...
            <div class="product-details-list view-switch">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="category-book">
                  <div id="category_tree"><h2>Category<span class="category-name"><b>\</b><?php $category_name = mysql_fetch_array($check_id);
                  ...
                  <div class="row clearfix" id="result_show">
					...
					$categories_select = mysql_query("SELECT * FROM `syt_post` WHERE `category` = '$_catid' order by `id` desc");
					
					$num_categories_select = mysql_num_rows($categories_select);
					
					if($num_categories_select == 0)
					{
						echo "<div style='font-size:24px;color:red'>No product found...</div>";
					}
					else
					{
						while($rwe = mysql_fetch_assoc($categories_select))
						{
							...
							$sql_kk= mysql_query("SELECT * FROM `syt_registration` WHERE `id` = '$userid'");
					...
					<div class="col-sm-4 col-xs-6">
                      ...
                      <div class="single-product">
                        ...
                        <h4><a href="blog-post.php?postid=<?php echo $rwe['id']; ?>"><?php echo $rwe['syt_title']; ?></a></h4>

                        <h5><a href="#"><?php echo $rwe['category']; ?></a>, <a href="#"><?php echo $rwe['subcategory']; ?></a></h5>

                        <p>
						<?php
							$str_len = strlen($rwe['syt_desc']); 
							$_str = $rwe['syt_desc']; 
							if($str_len < 135)
							{
								echo $rwe['syt_desc'];
							...
							{
								echo substr($_str,0,130)."...";
							}
						?>
						</p>

                        <a class="read-more" href="profile.php?id=<?php echo $usr['id'];?>"><i class="fa fa-angle-right"></i><?php echo "By ".$usr['firstname']." ".$usr['lastname'];; ?></a>
                ...
                <ul class="nav nav-tabs accordion-tab" role="tablist">
                  ...
                  <li>
                    <a href="#"><i class="fa fa-bullhorn"></i>Trainers and Tutors</a>
					 <?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 1");
                    ...
                    <div>
                      ...
                      <a  href="subcategory.php?<?php echo $row['subcategory'];?>" data-toggle="tab"><?php echo $row['subcategory'];?></a>
                  ...
                  <li class="active">
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 2");
						
						while($row = mysql_fetch_assoc($query))
						{
					 ?>
                    <div>
                      <a href="subcategory.php?subcategory=<?php echo $row['subcategory'];?>&category=<?php echo $category_name['category'];?>" role="tab" data-toggle="tab"><?php echo $row['subcategory'];?></a>
                  ...
                  <li>
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 3");
                  ...
                  <li>
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 4");
                  ...
                  <li>
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 5");
                  ...
                  <li>
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 6");
                  ...
                  <li>
					...
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 7");
                  ...
                  <li>
                    <a href="#"><i class="fa fa-building-o"></i>Other</a>
					<?php 
						$query = mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`= 8");
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
              ...
              <p>India’s first and largest services marketplace.
                 Sell your time for your skills, knowledge and experience.Start your business or generate qualified leads on SYT.If you are looking for services in your area,find service providers as per your need,budget and schedule.</p>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="newsletter">
              ...
              <form action="#">
                ...
                <button name="newletter"><i class="fa fa-plus"></i></button>
				 <?php 
					if(@$_POST['newletter'])
					{
						if(@$_POST['Email'])
						{
							echo "Thanks you for subscribing newletter";
						}
					}
				 ?>
              </form>
...
$(document).ready(function(){
	...
	$("#submit").click(function(){
		...
		var category = "<?php echo $category_name['category']; ?>";
