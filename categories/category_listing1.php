                    ...
                    <li>
                      ...
                      <button type="submit" class="btn btn-success" ><span class="glyphicon glyphicon-search"></span></button>
                                        ...
                                        <div class="row">
                                           ...
                                           <ul class="col-sm-3">
                                            ...
                                            <ul class="col-sm-3">
                                                ...
                                                <li><a href="category_listing.php?catg=Others&catid=8">And Everything Else</a></li>
                                           </ul> 
                                        </div><!-- end row -->
						...
						<?php
							...
							{
						?>
								<li><a href="../dashboard/index.php" style="color:#fff;" target="_blank"><?php echo $_SESSION['syt_email']; ?></a></li>
								<li><a href="../dashboard/logout.php" style="color:#fff;" target="_blank">Logout</a></li>
						<?php
							}
							else
							{
	...
	<nav>
		...
		<ul>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd2">Academic&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="category_listing.php?catid=1&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
				</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=2&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			<li><div href="#" style="padding:10px; background:#ccc; margin-bottom:2px;"  id="itd">IT&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="category_listing.php?catid=3&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=4&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=5&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=6&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=7&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=8&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
              ...
              <div class="tab-content">
				...
				<div class="col-sm-4 col-xs-6">
                      ...
                      <div class="single-product">
						...
						<p>
						<?php
							echo "<span style='color:orange'>Around</span> : ". $rwe['zip'];
						?>
						</p>
						<p>
						<?php
				...
				?>
                      ...
                      <div class="single-product">
                        ...
                        <h4><a href="profile.php?id=<?php echo $fetch_select_user['id']; ?>"><?php echo $fetch_select_user['firstname']." ".$fetch_select_user['lastname']; ?></a></h4>

                        <h5><a href="#"><?php echo $rwe1['subcategory']; ?></a>, <a href="#"><?php echo $rwe1['category']; ?></a></h5>

                        <p>
						<?php
							echo "<span style='color:orange'>Experience</span> : ". $rwe1['experience']." Years";
						?>&nbsp;&nbsp;&nbsp;&nbsp;
						<?php
							echo "<span style='color:orange'>Charge</span> : <i class='fa fa-inr'></i> ". $rwe1['charge'];
						?>
						</p>
						...
						<p>
						<?php
							echo "<span style='color:orange'>Around</span> : ".$fetch_select_user['zip'] ;
						?>
						</p>
						<p>
						<?php
							echo "<span style='color:orange'>Availability</span> : ". $rwe1['service_day'];
						?>
						</p>
						...
						<p>
						<?php
							$expr = strlen($rwe1['experience']);
							if($expr <= 146)
							{
								echo $rwe1['experience_details']." ...<a href='profile.php?id=".$fetch_select_user['id']."'>Read more</a>";
							}
							else
							{
								echo substr($rwe1['experience_details'],0,130)."...<a href='profile.php?id=".$fetch_select_user['id']."'>Read more</a>";
							}
						?>
						</p>
	...
	<nav>
		...
		<ul>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd12">Academic&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="category_listing.php?catid=1&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
				</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=2&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			<li><div href="#" style="padding:10px; background:#ccc; margin-bottom:2px;"  id="itd1">IT&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="category_listing.php?catid=3&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=4&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			...
			<?php 
				...
				{
			?>
					<li><a href="category_listing.php?catid=5&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
...
<script>
    ...
    slide: function( event, ui ) {
      $( "#amount" ).val( "Rs "+ ui.values[0]+" - Rs "+ui.values[1]);
		...
		var category1 = "<?php echo $rw; ?>";
		
		$.ajax
		({
			type: "POST",
			url: "be_price.php",
			data: "s="+s+"&s1="+s1+"&category="+category+"&zip="+zip+"&category1="+category1,
			cache: false,
			success: function(html)
			{
				$("#result_show").html(html)
