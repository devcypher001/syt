	...
	<section class="grey-wrapper jt-shadow">
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-md-12 col-xs-12 ">
                    <h1 style="font-size:30px;text-align:center;color:rgb(253, 105, 32);">You have successfully registered with SYT.<br>An email has been sent to your registered email id for account verification.</h1>
                </div>

                <div class="col-md-12 col-xs-12 ">
                    <h1 style="font-size:25px;text-align:center;color:green;">Click at the link provided and you will be redirected to the login page.<br>You can login via the chosen email and password OR  your chosen social media account.</h1>
                </div>
