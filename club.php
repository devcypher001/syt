                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse navbar-right" >
                    <ul class="nav navbar-nav">
                      <li class="dropdown yamm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:rgb(255, 174, 0);">Categories <div class="arrow-up"></div></a>
                        ...
                        <li><a href="howitworks.php" style="color:rgb(255, 174, 0);">How It Works</a></li>
                        <?php
				...
				return false;
					...
					$(document).ready(function(){
						$("#submit").click(function(){
							...
							var email = $("#email").val();
							var phone = $("#phone").val();
							var st = $("#selltime:checked").val();
							var bt = $("#buytime:checked").val();
							
							var dd = "first="+first+"&last="+last+"&email="+email+"&phone="+phone+"&st="+st+"&bt="+bt;
