              ...
              <ul class="dropdown-menu" style="font-size:22px;">
                                <li>
                                    <div class="yamm-content">
                                        <div class="row">
                                            <ul class="col-sm-3">
                                                <li><a href="categories/category_listing.php?catg=Trainers and Tutors&catid=1"  class="ch">Trainers and Tutors</a></li>
                                                <li><a href="categories/category_listing.php?catg=IT and Marketing&catid=3" >IT and Marketing</a></li> 
                                            </ul>
                                            <ul class="col-sm-3">
                                               <li><a href="categories/category_listing.php?catg=Home and Utility&catid=6" >Home and Utility</a></li>
                                                <li><a href="categories/category_listing.php?catg=Events & Entertainment&catid=7">Events and Entertainment</a></li>
                                            </ul>
                                           <ul class="col-sm-3">
                                                <li><a href="categories/category_listing.php?catg=Business Consultants&catid=2" >Business Consultants</a></li>
                                                <li><a href="categories/category_listing.php?catg=Fashion and Lifestyle&catid=4" >Fashion and Lifestyle</a></li>
                                           </ul>
                                            <ul class="col-sm-3">
                                                <li><a href="categories/category_listing.php?catg=Beauty and Wellness&catid=5" >Beauty and Wellness</a></li>
          ...
          ?>
            ...
            <div class="col-sm-3 col-md-3 col-lg-4 ">
              <div class="form-group">
                ...
                <input type="text" id="autocomplete" class=" form-control" style="font-weight:bold;"
...
background-color: rgb(255, 255, 255);display:none;cursor:pointer;"></div>
  ...
  <div class="form-group">
                ...
                <input type="text" id="autocomplete_min" class=" form-control input-lg " style="font-weight:bold;" placeholder="Vasant Kunj/ 110082" />
...
Browse what services people are looking for and share your profile with them.</h3>
             ...
             <div class="buttons padding-top text-center">
                <a href="register" class="btn btn-primary btn-lg" title="">Sign up</a>
                          ...
                          <div class="clearfix"></div>
             <div class="buttons padding-top text-center">
                <a href="<?php if(!empty($_SESSION['syt_id'])){echo "dashboard/post.php";}else{echo "register";} ?>" class="btn btn-primary btn-lg" title="">Post your requirement</a>
            </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="container">
            ...
            <div id="boxed-portfolio" class="portfolio_wrapper padding-top">
                ...
                <div class="col-lg-3 col-sm-6 col-md-3 col-xs-12 logo">
                    <div class="portfolio_item">
                        <div class="entry">
                            <img src="img/category_images.jpg" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="buttons">
                                    <a class="st btn btn-default" rel="bookmark" href="categories/category_listing.php?catid=9">View More</a>
                                    <h3>  Social Causes</h3>
                                </div><!-- end buttons -->
                            </div><!-- end magnifier -->
                        </div><!-- end entry -->
...
<td style="font-weight: bold;"><b style="text-decoration:underline;"><?php echo $rr['firstname']." ".$rr['lastname']; ?> </b> signed up to sell <?php if($rr['gender'] == "Male") { echo "his"; }else{ echo "her"; } ?> time under <?php echo $rr['subcategory']; ?> category in <?php if(strlen($rr['address']) > 20)
{
  echo substr($rr['address'],0,20);
}
else
{
  echo $rr['address'];
} ?><a href="categories/profile.php?id=<?php echo $rr['id'] ?>">&nbsp;&nbsp;&nbsp;Read more...</a></td>
</tr>
</table>
</li>
<?php
...
The variety of service providers is huge and unique. I can learn so much more across skills.
            ...
            <div class="testimonial">
            <p style="color:green;font-size:20px;"><img src="img/pic.jpg" width="78" height="80" />&nbsp;&nbsp;SYT Club is a unique and premium service</p> 
            <p class="lead">SYT has transformed the way I utilize my weekends productively. The
sheer variety of work on SYT allows me explore new avenues of my
interest and also makes me feel valued that I'm making great
contributions.


            </p>
              <p style="font-weight:400;">Vibhor Gandotra, Media Consultant, Hyderabad</p>
            </div><!-- end tweet -->
...
function fill_op(city)
  {
    $("#searchPinCodeLocality12").val(city);
    $("#search_down2").hide();
  }
...
$(document).ready(function(){
  ...
  $("#search_Result").click(function(){
    ...
    var d1 = "search="+search+"&sell="+sell+"&sell1="+sell1;
      ...
      //-------------------------------------------------------------
      else if(sell1 == "Social Causes" && sell=="Sell a service")
      {
        window.location="categories/lead_listing.php?catid=9";
      }
      else if(sell1 == "Social Causes" && sell=="Buy a service")
      {
        window.location="categories/category_listing.php?catid=9";
      }
  ...
  var search = $("#searchPinCodeLocality12").val();
    ...
    var d1 = "search="+search+"&sell="+sell+"&sell1="+sell1;
      ...
      {
        window.location="categories/lead_listing.php?catid=9&location_filled="+search;
      }
      else if(sell1 == "Social Causes" && sell=="Buy a service")
      {
        window.location="categories/category_listing.php?catid=9&location_filled="+search;
      }
  ...
  $("#searchPinCodeLocality12").keyup(function(e){
