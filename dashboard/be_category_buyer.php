...
$query= mysql_query("INSERT INTO `syt_post`(`id`, `zip`, `category`, `syt_title`, `syt_desc`, `subcategory`, `delievery_date`, `travel`, `price`, `keyword`, `experience`, `date`, `userid`, `service_distance`,`service_mode`,`charge_mode`, `notif`, `charge1`, `charge2`) VALUES ('','$zip','$c','$title','$desc','$d','$sd','','$pri','','$experience',NOW(),'$uid','$distance','$offer_service','$price','$notification','$min_price','$max_price')");
