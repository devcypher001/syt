                  ...
                  <div class="portlet box blue tabbable">
					 ...
					 <div class="portlet-title">
                        <h4>
                           ...
                           <span class="hidden-480">Social Links</span>
                           &nbsp;
                        </h4>
                     </div>
                              ...
                              <div class="tab-pane active" id="portlet_tab1">
                                 ...
                                 <form action="#" class="form-horizontal">                          
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" id="fb" placeholder="Facebook" class="m-wrap huge" />
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" id="twitter" placeholder="Twitter" class="m-wrap huge" />
                                          <span class="help-inline"></span>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" id="google" placeholder="Google +" class="m-wrap huge" />
                                          <span class="help-inline"></span>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="text" id="linkedin" placeholder="LinkedIN" class="m-wrap huge" />
                                          <span class="help-inline"></span>
                                       </div>
                                    </div>
