		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
							...
							<label style="font-size:20px;font-weight:bold;">Post your requirement to buy any service you need in your area.Please highlight details,experience required and price you willing to pay.</label><br>
									...
									<div class="col-sm-10 col-sm-offset-1" id="fixed_price" style="display:none;">
										...
										<div class="col-sm-6 col-sm-offset-1" id="">
                                         <div class="form-group" style="">
                                            ...
                                            <input type="checkbox" class="form-control">Both<br>
                                          </div>
										</div>
