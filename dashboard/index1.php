...
elseif (!empty($_GET['redirect'])) {
	$url = @$_GET['redirect'];
	header("Location:../categories/blog-post.php?postid=$url");
}
?>
<!DOCTYPE html>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							My Dashboard				<small>/ Buy services</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="index.php">My Dashboard / Buy services</a> 
				...
				function get2()
				{
					window.location = "message_buyer.php";
				}
				</script>
				<!-- END PAGE HEADER-->
				<!--Statistics And More-->
							...
							<div class="dashboard-stat green">
								...
								<div class="details">
									...
									<?php
										$userid = $_SESSION['syt_id'];
										$qwr = mysql_query("SELECT * FROM `syt_post` WHERE `userid`='$userid'");
										$fet_qwr = mysql_fetch_array($qwr);
										$f = $fet_qwr['id'];
										
										$g = mysql_query("SELECT * FROM `syt_seller_reply` WHERE `postid` = '$f'");
										
										echo mysql_num_rows($g);
									?>
									</div>
						...
						<div class="span4 responsive" data-tablet="span6  fix-offset" data-desktop="span4" style="cursor:pointer" onclick="get2()">
							<div class="dashboard-stat purple">
								...
								<div class="details">
									...
									<?php
									$re = $_SESSION['syt_id'];
									$count_message = mysql_query("SELECT * FROM `syt_message` WHERE `source`='$re' or `destination` ='$re'");
								...
								<a class="more" href="message_buyer.php">
								View more <i class="m-icon-swapright m-icon-white"></i>
								</a>						
							</div>
						</div>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box">
							...
							<label style="font-size:20px;font-weight:bold;">Post your requirement to buy any service you need in your area.Please highlight details of your requirement,experience required and price you are willing to pay.</label><br>
                        <form action="#" class="form-horizontal">
							 ...
							 <div class="form-group">
                                <label for="sel1">When do you need this service? (You can either select days of the week or specific dates when you need the service)</label>
								 ...
								 OR
								 <input type="date" id="service_day1"/>&nbsp;-&nbsp;<input type="date" id="service_day1"/>
                              </div>
							 <br>
									...
									<div class="col-sm-10 col-sm-offset-1" id="fixed_price" style="display:none;">
										...
										<div class="col-sm-6 col-sm-offset-1" id="">
                                         <div class="form-group" style="">
                                            ...
                                            <input type="checkbox" class="form-control">By email<br>
                                            <input type="checkbox" class="form-control">By text<br>
		...
		$("#category").change(function(){
			...
			$("#submit").click(function(){
				...
				var zip = $("#zip1").val();
				 ...
				 var ajaz = "c="+c+"&d="+d+"&title="+title+"&desc="+desc+"&service_day="+service_day+"&service_day1="+service_day1+"&offer_service="+offer_service+"&distance="+distance+"&price="+price+"&fixed_pro="+fixed_pro+"&min_price="+min_price+"&max_price="+max_price+"&experience="+experience+"&zip="+zip;
