												...
												<div class="tab-content">
													...
													<div id="tab_2-2" class="tab-pane">
														<div style="height: auto;" id="accordion2-2" class="accordion collapse">
															<form action="#">
																<p style="font-size:19px;">Upload a Selfie (a photo one has taken of oneself)<br>We recommend uploading a clear and professional photo.</p>
																<br />
																<div class="controls">
														...
														<div style="height: auto;" id="accordion4-4" class="accordion collapse">
															<form action="#">
																<div class="profile-settings row-fluid">
																	<div class="span7">
																		<p>How do you wish to be notified by a service provider for your requirement?</p>
																...
																<div class="profile-settings row-fluid">
																	<div class="span7">
																		<p>When a service provider tries to contact you,would you like to share your phone number and email id or both? </p>
																		<p style="font-weight:bold;">*We suggest sharing both as it increases chances of getting the right service provider quicker.</p>
																	</div>
																	<div class="control-group span5">
																		<div class="controls">
																			<label class="radio">
