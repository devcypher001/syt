		...
		<div class="page-content">
					...
					<table class="table table-striped table-bordered table-advance table-hover">
						<thead>
							<tr>
								...
								<th class="hidden-phone"><i class="icon-briefcase"></i> Email</th>
								<th class="hidden-phone"><i class="icon-briefcase"></i> Phone</th>
								<th class="hidden-phone"><i class="icon-briefcase"></i> Location</th>
								<th class="hidden-phone"><i class="icon-briefcase"></i> Description</th>
          ...
          <!-- /.modal --> 
								 <!----my code------->		 
										...
										<td><a href="<?php echo $rwr['id'];?>">View post</a></td>
				...
				<div class="row-fluid">
					...
					<table class="table table-striped table-bordered table-advance table-hover">
						<thead>
							<tr>
								<th><i class="icon-briefcase"></i> Name </th>
								<th><i class="icon-briefcase"></i> Email</th>
								<th><i class="icon-briefcase"></i> Location</th>
								<th><i class="icon-briefcase"></i> Description</th>
						...
						<?php
							$post_category = $fet_check_title_query['category'];
							$qwr = mysql_query("SELECT * FROM `syt_post` WHERE `category` = '$post_category'");
						...
						else
						{
							...
							?>
								...
								<tbody>
									...
									<tr>
										<td><?php echo $fet_rt['firstname']." ".$fet_rt['lastname'];?></td>
										<td><?php echo $fet_rt['email']; ?></td>
										<td><?php echo $fet_rt['address']." ".$fet_rt['zip']; ?></td>
										<td>
										
										
										
										<a data-toggle="modal" href="#myModal1<?php echo $rwr['id'];?>" class="btn btn-orange btn-lg" cc="<?php echo $rwr['syt_desc']; ?>">View</a> 
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body"><b> Description </b>:  <?php echo $rwr['syt_desc']; ?><br></div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-orange" data-dismiss="modal">Close</button>
            ...
            <!-- /.modal-dialog --> 
										...
										<td><a href="mailto:<?php echo $fet_rt['email'];?>"><?php echo "Send email to ".$fet_rt['email']; ?></a></td>
										<td><a href="../categories/blog-post.php?postid=<?php echo $rwr['id']; ?>">View Post</a></th>
									</tr>
