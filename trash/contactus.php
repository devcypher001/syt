...
<body>
	...
	<section style="background-image: url('img/contact_banner.jpg');" data-stellar-background-ratio="0.6" data-stellar-vertical-offset="20">
		<div class="overlay">
        	<div class="container" style="height:220px;">
				dafsssssssssssssssss
            </div><!-- end container -->
    	</div><!-- end overlay -->
    	...
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-md-12 col-xs-12 ">
                    <h1 style="font-size:30px;text-align:center;">For any queries & feedback,we will be more than happy to help you.Please give us the following details or email us at <a href="mailto:contact@sellyourtime.in?Subject=SYT Contact">contact@sellyourtime.in</a></h1>
                </div>
