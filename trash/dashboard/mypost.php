														...
														<table class="table table-striped table-bordered table-advance table-hover">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><a class="btn mini green-stripe" href="../categories/blog-post.php?postid=<?php echo $rwr['id']; ?>">View</a></td>
																	
																	<td>
																	<div class="delete_cross" ccd="<?php echo $rwr['id']; ?>">
