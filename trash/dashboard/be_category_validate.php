...
if($num_qq1 < 2)
{
	if($num_kk == 0)
	{
		$qwe = mysql_query("INSERT INTO `syt_add_category`(`id`, `category`, `subcategory`,`other`,`experience`,`experience_details`,`doc`, `service_distance`,`charge_mode`,`charge`,`time`,`service_day`,`dob`,`service_mode`,`user_id`) VALUES ('','$c','$d','','$experience','$detail_experience','$doc','$distance','$price','$charge',NOW(),'$service_day','','$service_mode','$uid')");
