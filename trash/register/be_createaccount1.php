...
if($dob3 == "ok")
{
	...
	if($insert)
	{
		...
		$mail->Body .= "<tr><td colspan=2>Dear $firstname $lastname,<br /><br />Welcome to sellyourtime.you are just one step away from confirming your registration on sellyourtime, all you need to do is verify $email as your sellyourtime ID to activate click on the link below </td></tr>";
		...
		$mail->Body .= "</table>";
		$mail->Body .= "</body></html>";
		$mail->Body  .= "http://www.sellyourtime.in/register/verify.php?id=".str_rot13($email);
