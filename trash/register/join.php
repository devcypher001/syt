                                 ...
                                 <label class="radio-inline" style="font-weight:bold;color:#000084;">
                                  <input type="radio" name="optradio" style="margin-top: 4%;" id="company">We are company</label>&#42;</div>
                                   ...
                                   <div class="col-sm-10 col-sm-offset-1" style="margin-top:2%;">
                                       <div class="form-group">
                                            <label style="color:#000084;">Select Category for your profession?</label>&#42;<br>
											<p style="font-size:13px;">Select a category under which you would like to offer your services? If the category is not listed select ‘other’</p>
								  ...
								  <!--OTHER  SUB Category  DISPLAY NONE-->
                                   ...
                                   <div class="col-sm-10 col-sm-offset-1">
									...
									<div class="row">
									<div class="col-sm-11 col-sm-offset-1" style="margin-left: 10%;color:grey;font-weight:bold;">
                                    ...
                                    <div class="col-sm-5 col-sm-offset-1" style="margin-top:2%;">
									 ...
									 <!--<div class="col-sm-4">
                                         <div class="form-group">
											...
											<div id="search_down1" style="background:black;color:white;display:none;cursor:pointer;"></div>
                                          </div>
                                    </div>-->
									<div class="col-sm-5 col-sm-offset-1">
                                         <div class="form-group">
                                            <label style="color:#000084;">Zip/Area</label>&#42;
                                            <input type="text" class="form-control" placeholder="110085" id="zip">
				 ...
				 ({
					...
					//	console.log(display)
						if(display == 1)
						{
							...
							$("#lastname").css('border','1px solid white');
							$("#dob").css('border','1px solid white');
							$("#category").css('border','1px solid white');
							$("#subcategory1").css('border','1px solid white');
							$("#experience").css('border','1px solid white');
							$("#phone").css('border','1px solid white');
							$("#detail_experience").css('border','1px solid white');
							$("#zip").css('border','1px solid white');
							$("#city").css('border','1px solid white');
							$("#client_site").css('border','1px solid white');
							$("#price").css('border','1px solid white');
							$("#min_price").css('border','1px solid white');
							$("#max_price").css('border','1px solid white');
							$("#service_day").css('border','1px solid white');
							
							$("#result").html("<font size='4' color='red'>Enter your firstname</font>");
						}
						else if(display == 2)
						{
							$("#firstname").css('border','1px solid white');
						...
						else if(display == 15)
						{
							...
							$("#min_price").css('border','1px solid white');
							$("#max_price").css('border','1px solid white');
							$("#service_day").css('border','1px solid red');
						}
						else if(display == 16)
						{
							$("#firstname").css('border','1px solid white');
