...
define('DB_SERVER_USERNAME', 'appslkeg_resal2');
define('DB_SERVER_PASSWORD', '@resale@');
define('DB_DATABASE', 'appslkeg_resale2');
...
define("API_KEY", "75yaepsmtfx7ez");
define("SECRET_KEY", "a5bRELKQewpWnBcf");
/* make sure the url end with a trailing slash */
define("SITE_URL", "http://appslure.com/sellyourtime/new/register/linkedin/");
