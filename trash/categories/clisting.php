	...
	<nav>
		...
		<ul>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd2">Academic&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=1&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
				</div>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=2&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<li><div href="#" style="padding:10px; background:#ccc; margin-bottom:2px;"  id="itd">IT&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=3&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=4&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=5&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=6&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=7&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=8&sub=<?php echo $k1['sub_subcate']; ?>"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="category-book">
                  ...
                  <div class="row clearfix" id="result_show">
					...
					{
						echo "<font size='5' style='text-align:justify;'>Looking to buy services under ".$rw."?<br>&nbsp;&nbsp; Please <a href='interest.php'>register</a> your interest.</font>";
					}
					else
					{
	...
	<nav>
		...
		<ul>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd2">Academic&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=1&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
				</div>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=2&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<li><div href="#" style="padding:10px; background:#ccc; margin-bottom:2px;"  id="itd">IT&nbsp;<i class="fa fa-sort-down"></i></div></li>
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=3&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
			</div>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=4&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
	...
	<nav>
		...
		<ul>
			<?php 
				...
				{
			?>
					<li><a href="subcategory_listing.php?catid=5&sub=<?php echo $k1['sub_subcate']; ?>" target="_blank"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
		</ul>
