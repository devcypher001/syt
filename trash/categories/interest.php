                                        ...
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3">
                                               <li><a href="category_listing.php?catid=6">Home and Utility</a></li>
                                                <li><a href="category_listing.php?catid=9">Events and Entertainment</a></li>
                                            </ul>
                                           <ul class="col-sm-3">
...
margin-bottom: -28px;">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email" style="color: #fff;">Name :</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email" style="color: #fff;">Select Category :</label>
    <div class="col-sm-10">
  ...
  <div class="form-group" style="display:none;" id="subcategory">
    <label class="control-label col-sm-2" for="email" style="color: #fff;">Select Subcategory :</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd" style="color: #fff;">Email :</label>
    <div class="col-sm-10"> 
      <input type="text" class="form-control" id="email" placeholder="Enter email id">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="email" style="color: #fff;">Phone Number:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="phone" placeholder="Enter phone number" maxlength="13" value="91">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="email" style="color: #fff;">Post your requirement :</label>
    <div class="col-sm-10">
