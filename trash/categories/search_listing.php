                                        ...
                                        <div class="row">
                                           ...
                                           <ul class="col-sm-3">
                                            ...
                                            <ul class="col-sm-3">
                                                ...
                                                <li><a href="categories/category_listing.php?catid=7">And Everything Else</a></li>
                                           </ul> 
                                        </div><!-- end row -->
    ...
    <div class="header-search map">
      <div class="header-search-bar">
          ...
          <div class="container">
			...
			<div class="category-search">
                <select class="" data-placeholder="-Select Subcategory-" id="sub_category" style="width: 101%;
height: 41px;
margin-top: -0.4%;
margin-left: 2%;
border-radius: 5px;
border: none;">
				<?php
					...
					{
						$q= mysql_query("SELECT * FROM `syt_subcategory` WHERE `parent_category`=1");
						
						while($rr4 = mysql_fetch_assoc($q))
						{
							$qid = $rr4['id'];
					?>
							<optgroup label=<?php echo $rr4['subcategory'];?>>
								<?php 
									$q1 = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = '$qid'");
									while($rr5 = mysql_fetch_assoc($q1))
									{
					?>
										<option value='<?php echo $rr5["sub_subcate"]; ?>'><?php echo $rr5["sub_subcate"]; ?></option>
							<?php
									}
							?>
							</optgroup>
            ...
            <div class="product-details-list view-switch">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="category-book">
				  ...
				  ?></span><span class="comments"></span></h2></div>

                  <div class="change-view">

                    <div class="sort-by">

                      <select class="" id="sortby" style="width: 215px;
padding: 8px;">
                  ...
                  <div class="row clearfix" id="result_show">
					...
					$categories_select = mysql_query("SELECT * FROM `syt_registration` WHERE `category` ='$rw' order by `id` desc");
					...
					<div class="col-sm-4 col-xs-6">
                      ...
                      <div class="single-product">
						...
						<?php
							...
							if($expr <= 146)
							{
								echo $rwe['experience_details'];
							}
							else
							{
								echo substr($rwe['experience_details'],0,130)."...";
							}
						?>
						</p>
            ...
            <div class="location-details">
                ...
                <div class="select-country">
				  ...
				  <br>
					...
					<div class="show" style="margin-left: 235px;position: relative;top: -43px;width: 55px;left: 0px;">5 yr</div>
...
<div class="accordion">
	...
	<nav>
		...
		<ul>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd2">Academic&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="mks2">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = 1");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
			<?php
				}
			?>
				</div>
				
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd3">Language Experts&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="mks3">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = 2");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd4">Arts and Crafts&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="mks4">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = 6");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd5">Sports & Recreation&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="mks5">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = 4");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd6">Performance Arts&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="mks6">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `grand_parent_id` = 3");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
	...
	<nav>
		...
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 2");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
	...
	<nav>
		<h2><i class="fa fa-graduation-cap"></i>IT and Marketing</h2>
		<ul>
			<li><div href="#" style="padding:10px; background:#ccc; margin-bottom:2px;"  id="itd">IT&nbsp;<i class="fa fa-sort-desc"></i></div></li>
				<div style="margin-left:10px;display:none;"  id="its">
					
					<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 4");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
			...
			<li><div href="#" style="padding:10px; background:#ccc;" id="mkd1">Marketing&nbsp;<i class="fa fa-sort-desc"></i></div></li>
	...
	<nav>
		<h2><i class="fa fa-paper-plane-o"></i> Fashion and Lifestyle</h2>
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 4");
				while($k1 = mysql_fetch_assoc($kk))
	...
	<nav>
		<h2><i class="fa fa-paper-plane-o"></i>Beauty and Wellness</h2>
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 5");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
	...
	<nav>
		...
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 6");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
	...
	<nav>
		<h2><i class="fa fa-book"></i> Events & Entertainment</h2>
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 7");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
	...
	<nav>
		...
		<ul>
			<?php 
				$kk = mysql_query("SELECT * FROM `syt_sub_sucategory` WHERE `parent_id` = 8");
				while($k1 = mysql_fetch_assoc($kk))
				{
			?>
					<li><a href="#"><?php echo $k1['sub_subcate']; ?></a></li>
...
Sell your time for your skills, knowledge and experience. Start your business or generate qualified leads on SYT.If you are looking for services in your area,find service providers as per your need, budget and schedule.
        	...
        	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            	<div class="widget">
                	<div class="title">
                        <h3><div class="club" style="color:gold; text-shadow: 4px 4px 2px rgba(150, 150, 150, 1);text-transform: capitalize;">Sell your time Club</div></h3>
						<span style="color:#FD6920;">A premium club where you can do paid networking and meet almost anyone by paying the price of their time.</span>
                    </div><!-- end title 
			...
			<div class="col-lg-7 col-md-6 col-sm-12 clearfix">
				<div class="footer-menu">
                    <ul class="menu">
                        ...
                        <li><a href="#">Post My Job</a></li>
                        <li><a href="#">Terms of Service</a></li>
                        <li><a href="#">Privacy Policy</a></li>
                        <li><a href="#">Sell your time club</a></li>
