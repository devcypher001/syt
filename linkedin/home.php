...
$linked = explode(" ",$_SESSION['name']);

$linked_fn = $linked[0];
$linked_ln =  $linked[1];
$linked_email = $_SESSION["email"];

echo $linked_email." ".$linked_fn." ".$linked_ln;
?>
...
function myFunction()
{
	...
	$(document).ready(function(){
		$("#sell").click(function(){
			var email = "<?php echo $linked_email; ?>";
			var fn= "<?php echo $linked_fn; ?>";
			var ln= "<?php echo $linked_ln; ?>";
			alert("Sell")
			...
			if(ert == 0)
			{
				window.location="../register/join.php?_emN9VOG="+btoa(email)+"&title_tmPNDddk="+tt+"&first_name="+fn+"&last_name="+ln;
			}
			else
			{
				window.location ="check.php?email="+email;
			}				
		});
		...
		$("#buy").click(function(){
			...
			if(ert == 0)
			{
				window.location="../register/join1.php?_emN9VOG="+btoa(email)+"&title_tmPNDddk="+tt+"&first_name="+fn+"&last_name="+ln;
			}
			else
			{
				window.location ="check.php?email="+email;
