...
<?php 
 //echo $content['email']." ".$content['given_name']." ".$content['family_name'] ;
?>
...
function myFunction()
{
	...
	$(document).ready(function(){
		$("#sell").click(function(){
			...
			var email= "<?php echo $content['email']; ?>";
			var fn= "<?php echo $content['given_name']; ?>";
			var ln= "<?php echo $content['family_name']; ?>";
