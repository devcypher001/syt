		...
		<div class="row">
			...
			<div class="container newpannel" >
				<div class="row">
					...
					<div id="result" style="font-size:17px;color: red;">Please choose an option above</div>
					...
					<div class="row" style="margin-top:5%;">
						<div class="col-lg-10 col-sm-6 col-sm-offset-1 "  style="text-align:center;">
							<a href="https://accounts.google.com/o/oauth2/auth?response_type=code&redirect_uri=https%3A%2F%2Fwww.sellyourtime.in%2Fgoogle%2Findex.php&client_id=689936831541-7roq6n4oebe0nn7agh0g0u4l58jucq9s.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email&access_type=offline&approval_prompt=force"><img src="images/google.png" alt="" id="social_ico"/></a>
						</div>
					</div>
