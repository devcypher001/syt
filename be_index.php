...
if(mysql_num_rows($qer) == 0)
{
...
else
	{
		...
		{
?>
			<p onclick="fill('<?php echo $row['place']." (".$row['zipcode'].")";?>')" cc="<?php echo $row['place']." (".$row['zipcode'].")"?>"><img src="img/pin.png" width="20" height="20"><?php echo $row['place']." (".$row['zipcode'].")"?></p>
<?php
