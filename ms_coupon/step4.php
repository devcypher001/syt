        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <p class=" text-center">The M&S End of Season Sale voucher</p>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-sm-offset-3">
                ...
                <div class="row">
                    ...
                    <p class="msg1">Also additional 10% cashback on</p>
                    <div class="row">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-2 col-sm-offset-2">
                           <img src="img/bank.png" class="img-responsive text-center"> 
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12 col-md-offset-4 col-sm-offset-4 text-center">
                        <p class="msg">Don't Forget to redeem this voucher <br> by 20th July,2019</p>
                    </div>
                </div>
