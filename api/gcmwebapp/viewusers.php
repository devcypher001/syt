...
<td><span>Pranav mittal newsd id</span></td>
...
<select id="festival">
<option value="http://appslure.com/syt/api/gcmwebapp/img/diwali.png">Diwali</option>
<option value="http://appslure.com/syt/api/gcmwebapp/img/pongal.png">Pongal</option>
<option value="http://appslure.com/syt/api/gcmwebapp/img/christmas.png">Christmas</option>
<option value="http://appslure.com/syt/api/gcmwebapp/img/ramzan.png">Ramadan</option>
</select>
<br/>
<img src="http://appslure.com/syt/api/gcmwebapp/img/diwali.png"/>
</div>
<div class="leftdiv">
